...
class RomPatcher:
    ...
    IPSPatches = {
        ...
        'Logic': {
            ...
            "mirror": ['mirrortroid.ips', 'bank_8f.ips', 'bank_83.ips', 'map_icon_data.ips',
                       ...
                       'crab_mt_everest.ips', 'mother_brain.ips', 'kraid.ips', 'torizos.ips']
        },
        # add debug tools
    ...
    def replaceEnemy(self, ptr, newEnemy):
        ...
        ptr += 2
        ptr += 4    # X and Y pos
        self.romFile.writeWord(newEnemy.Orientation, ptr)
        ptr += 2
        self.romFile.writeWord(newEnemy.Special, ptr)
        ptr += 2
        self.romFile.writeWord(newEnemy.SpecialGFX, ptr)
        ptr += 2
        self.romFile.writeWord(newEnemy.Speed, ptr)
        ptr += 2
    ...
    def randomizeRoomEnemies(self, room, enemyLvl):
        ...
        while (replaceID := self.romFile.readWord(ptr)) != 0xFFFF:
            if replaceID in replaceMap:
                self.replaceEnemy(ptr, replaceMap[replaceID])
            ptr += 16
